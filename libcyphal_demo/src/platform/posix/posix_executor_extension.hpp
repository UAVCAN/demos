...
public:
    ...
    virtual cetl::optional<PollFailure> pollAwaitableResourcesFor(const cetl::optional<libcyphal::Duration> timeout) const = 0;
...
#endif  // PLATFORM_POSIX_EXECUTOR_EXTENSION_HPP_INCLUDED
